<template>
  <svg :width="width" :height="height" :fill="color" viewBox="0 96 960 960" xmlns="http://www.w3.org/2000/svg">
...
<style lang="scss" scoped>
  .fill-class {
    fill: var(--v-internal-icon-text-base);
  }
</style>